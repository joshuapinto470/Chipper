...
import { FiSearch, FiHome, FiBell, FiMessageSquare, FiUser, FiLogOut } from "react-icons/fi";
            ...
            <div className="w-[275px]">
                <div className="overflow-y-auto fixed h-screen pr-3 w-[275px]">
                    ...
                    <nav className="mt-5 px-2">
                        <Nav Icon={<FiHome className="mr-4 h-6 w-6 " />} Heading="Home" to="/home" />
                        <Nav Icon={<FiSearch className="mr-4 h-6 w-6 " />} Heading="Explore" to="/home" />
                        <Nav Icon={<FiBell className="mr-4 h-6 w-6 " />} Heading="Notifications" to="#" />
                        <Nav Icon={<FiMessageSquare className="mr-4 h-6 w-6 " />} Heading="Messages" to="#" />
                        <Nav Icon={<FiUser className="mr-4 h-6 w-6 " />} Heading="Profile" to={`/profile/${user._id}`} />
                                ...
                                <div className="flex items-center">
                                    <div>
                                        <img className="inline-block h-10 w-10 rounded-full"
                                            src={`${BASE_API}/assets/${user_picture}`}
                                            alt="" />
                                    </div>
                                    <div className="ml-3">
