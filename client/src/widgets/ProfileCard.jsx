        ...
        <div>
            <div className="w-full bg-cover bg-no-repeat bg-center h-[200px]">
                <img className="w-full h-full"
                    src={`${BASE_API}/assets/${banner}`} alt="" />
            </div>
            <div className="p-4">
                ...
                <div className="space-y-1 justify-center w-full mt-3 ml-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm leading-5 font-medium text-gray-600">@{handle}</p>
                    </div>

                    <div className="mt-3">
                        <p className="text-white leading-tight mb-2">{bio}</p>
                        <div className="text-gray-600 flex">
                            <span className="flex mr-2"><svg viewBox="0 0 24 24" className="h-5 w-5 paint-icon">
                                <g>
                                    <path
                            ...
                            </svg> <a href={email} target="#"
                                className="leading-5 ml-1 text-blue-400">{email}</a></span>
                            <span className="flex mr-2"><svg viewBox="0 0 24 24" className="h-5 w-5 paint-icon">
                                <g>
                                    <path
                    ...
                    <div
                        ...
                        <div className="text-center pr-3"><span className="font-bold text-white">{followingLength}</span><span
                            className="text-gray-600"> Following</span></div>
                        <div className="text-center px-3"><span className="font-bold text-white">{followersLength}</span><span
                            className="text-gray-600"> Followers</span></div>
                    </div>
                </div>
            </div>
