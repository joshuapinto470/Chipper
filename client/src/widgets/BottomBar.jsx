      ...
      <div className="lg:hidden fixed overflow-hidden bottom-0 left-0 z-50 w-full h-16 border-t border-gray-200 bg-white">
        <div className=" text-gray-400 grid h-full max-w-lg grid-cols-3 mx-auto">
          <button
            ...
            <svg
              className="w-9 h-9 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500"
          ...
          <button
            ...
            className="inline-flex flex-col items-center justify-center font-medium px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
            <svg
              className="w-10 h-10 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500"
              viewBox="0 0 24 24"
              fill="currentColor"
              height="1em"
              width="1em">
